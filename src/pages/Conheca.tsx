      ...
      <section className="relative overflow-hidden min-h-[90vh] flex items-center justify-center">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-24 md:py-32">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg md:text-xl text-gray-600 leading-relaxed max-w-2xl">Você precisa de uma ferramenta que cumpre (muito bem) o que promete fazer. Chega de CRMs imobiliários complexos e lentos. Conheça um CRM focado apenas no que importa hoje pra você, VENDAS.
              <strong className="text-gray-900">(muito bem)</strong> o que foi feita para fazer.
