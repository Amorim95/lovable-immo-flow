...
export function NotificationPromptBanner() {
  ...
  // - Já tem subscription no banco
  // - Foi dispensado
  // - Usuário não está logado
  if (!isSupported || permission === 'granted' || hasSubscription || dismissed || !user || hasSubscription === null) {
    return null;
  }

  // Não mostrar se a permissão foi negada permanentemente
  if (permission === 'denied') {
    return null;
  }

  return (
    <div className="bg-gradient-to-r from-primary/90 to-primary text-primary-foreground rounded-lg p-4 mx-4 mb-4 shadow-lg animate-in slide-in-from-top-2 duration-300">
