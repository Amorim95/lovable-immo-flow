        ...
        {isEnabled && <div className="space-y-3 pt-2 border-t">
            ...
            <div className="flex items-start gap-2 p-3 bg-muted/50 rounded-lg text-sm">
              ...
              <div className="text-muted-foreground">
                <p>Se o corretor não clicar em "Contato" no tempo limite, o lead será transferido para o próximo da fila.<strong>{minutes} minutos</strong>, o lead será transferido para o próximo da fila.</p>
