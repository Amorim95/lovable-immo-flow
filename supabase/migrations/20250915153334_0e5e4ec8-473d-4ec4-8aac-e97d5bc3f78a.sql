-- Corrigir função create_lead_safe para não retornar erro em duplicatas
...
DECLARE
  ...
  new_lead_id uuid;
BEGIN
  -- Verificar se já existe um lead with o mesmo telefone nos últimos 30 segundos
  ...
  -- Se encontrou duplicata recente, retornar como duplicata (SEM ERRO)
